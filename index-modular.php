<?php
// Adishakti Furnitures - Modular Homepage
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/sections/premium-furniture.css">
    <link rel="stylesheet" href="assets/css/sections/indias-finest-brand.css">
</head>
<body>
    <!-- Navigation -->
    ...
    <main>
        <div class="hero">
            ...
            <?php include 'sections/premium-furniture.php'; ?>

            <!-- Featured Collection Banner -->
            <?php include 'sections/featured-banner.php'; ?>
